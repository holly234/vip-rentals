    ...
    <div className="w-full bg-white border border-gray-300 rounded-xl p-7 shadow-md">
      ...
      <div className="grid grid-cols-2 gap-0 mb-6 border border-gray-200 rounded-lg overflow-hidden divide-x">
        <div className="flex flex-col">
          ...
          <input type="date" className="p-3 text-base border-none outline-none focus:ring-0" />
        </div>
        <div className="flex flex-col">
          <label className="text-sm text-gray-500 px-4 pt-4">Time*</label>
          <input type="time" className="p-3 text-base border-none outline-none focus:ring-0" />
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="flex items-center space-x-3 mb-3">
          ...
          />
          <label htmlFor="self" className="text-base text-gray-800">Self pickup</label>
        </div>
        <div className="flex items-center space-x-3">
          <input
            ...
            className="w-4 h-4 border border-gray-400 rounded-sm focus:ring-1 focus:ring-black"
          />
          <label htmlFor="deliver" className="text-base text-gray-800">Delivered to you</label>
        </div>
      </div>
